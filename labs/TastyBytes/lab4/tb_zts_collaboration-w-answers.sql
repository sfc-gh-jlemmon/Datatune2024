/***************************************************************************************************
Adapted from: https://github.com/Snowflake-Labs/sf-samples/blob/main/samples/tasty_bytes/tb_zts_collaboration.sql
...
/******************************* TASK **************************************************************
Using the frostbyte_tasty_bytes.analytics.orders_v table, find the daily sales by location for 2022
***************************************************************************************************/
-- Your work:
SELECT orders.date, orders.primary_city, sum(orders.price) as daily_sales
from frostbyte_tasty_bytes.analytics.orders_v orders
where date_part(year, orders.date) = 2022
group by orders.date, orders.primary_city
order by primary_city, date
;
